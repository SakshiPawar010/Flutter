        ...
        home: Scaffold( 
          ...
          body: Consumer<Match>(
            builder: (context, value, child) {
              log("In Consumer");
              return Center(
                child: Text(Provider.of<Player>(context).playerName)        //Ithe error yenar nahi karan consumer la saglyat last la call jato(consumer heirarchy madhe call hot nahi)
              );
            },
            //child: Text(Provider.of<Player>(context).playerName),   //Register Karaychya aadhich fetch kartoy tyamule error
          ),
        ),
      ),   
    );
...
//           const SizedBox(height: 50,),
//           Consumer(                             //Consumer calls buildWithChild method internally
//             builder:(context,provider,child){   //chnage data kelyavr fakt ithech call jato
//               log("In Consumer");               //Saglyat last la call jato karan consumer la saglyat latest data bhetayla hava(Normal class nantr call q)
//               return Column( 
//                 children: [ 
