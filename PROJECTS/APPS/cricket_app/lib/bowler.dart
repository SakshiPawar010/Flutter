...
import 'package:cricket_app/bowlerProfile.dart';

//import 'package:image_picker/image_picker.dart';

class Bowler extends StatefulWidget {
  const Bowler({super.key});

  @override
  State createState() => _BowlerState();
}

class BowlerModelClass {
  int? id;
  String country;
  String born;
  String birthPlace;
...
class _BowlerState extends State {
  @override
  void initState() {
    super.initState();
    initializedDatabase();
  ...
  Future initializedDatabase() async {
    bowlerInfoList = await activeDatabase(); // DATA COPY
    setState(() {});
  }

  // DATABASE CREATE AND ACTIVATED
  Future<List<BowlerModelClass>> activeDatabase() async {
    // try{
    ...
    // }
    List<BowlerModelClass> initialList = await getData();
    return initialList;
  }

  // DATA INSERT INTO DATABASE
  Future<void> insertData(BowlerModelClass obj) async {
    ...
    bowlerInfoList = await getData();
    setState(() {});
    print("Data inserted successfully");
  }

  // FETCH OR RETRIVE DATA IN DATABASE
  Future<List<BowlerModelClass>> getData() async {
    final localDB = await database;
    print("Data Fetched Successfully");
    List<Map<String, dynamic>> mapList = await localDB.query("BowlerData");
    return List.generate(mapList.length, (index) {
      return BowlerModelClass(
        id: mapList[index]['id'],
  ...
  Future<void> deleteDataBaseCard(BowlerModelClass obj) async {
    final localDB = await database;
  ...
  Future<void> updateDataBase(BowlerModelClass obj) async {
    final localDB = await database;
  ...
  void showBottomSheet(bool flag, [BowlerModelClass? editIndex]) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
          itemCount: bowlerInfoList.length,
          itemBuilder: (context, index) {
            return Slidable(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            removeTask(bowlerInfoList[index]);
                          },
                          child: Container(
                            height: 32,
                            width: 32,
              ...
              child: GestureDetector(
                onTap: (){
                  final passIndex = bowlerInfoList[index];
                  print(passIndex);
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => BowlerAllInfo(bowlerInfo: passIndex,),)
                  );
                },
                child: Container(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(bowlerInfoList[index].playerImage),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              bowlerInfoList[index].playerName,
                              style: GoogleFonts.quicksand(
                                fontSize: 20,
  ...
  void editTask(BowlerModelClass batsmanModelObj) {
  ...
  // REMOVE TASK
  Future<void> removeTask(BowlerModelClass obj) async {
  ...
  void onSubmit(bool flag, [BowlerModelClass? editIndex]) async {
...
//                           onPressed:(){
//                             setState(() {
//                               bowlerInfoLList.add([playerNameController.text,_image, descriptionController.text]);
//                             });
//                             //submit();
//                             Navigator.of(context).pop();
//                           } ,
...
//       body: ListView.builder(
//         itemCount: bowlerInfoLList.length,
//         itemBuilder: (context, index){
//           return Column(
//             crossAxisAlignment: CrossAxisAlignment.center,
//             children: [
...
//                         child: _image == null
//                           ? const Text("No Image")
//                           : Image.file(bowlerInfoLList[index][1]),
//                       ),
//                     ),
//                     const SizedBox(width: 10,),
//                     Column(
